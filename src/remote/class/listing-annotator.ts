...
export class ListingAnnotator {
    ...
    private readonly onMutations: MutationCallback = () => {
        this.scheduleScan();
    };
    private readonly onPopState = (_event: PopStateEvent): void => {
        this.scheduleScan();
    };
    ...
    constructor(
        private readonly resolver: DistanceResolver,
    ...
    private annotateElement(element: HTMLElement, distance: number | undefined): void {
