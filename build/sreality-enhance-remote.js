(function () {
    ...
    // class/listing-annotator.ts
    class ListingAnnotator {
        constructor(resolver, anchorSelector) {
        ...
        annotateElement(element, distance) {
    ...
    (() => {
        ...
        const annotator = new ListingAnnotator(distanceResolver, 'a[href^="/detail/"], a[href^="https://www.sreality.cz/detail/"]');
